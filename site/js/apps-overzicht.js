(() => {
  ...
  let message = 'U bekijkt deze pagina op een computer of tablet. U kunt alle toepassingen hier uitproberen. Open de installatie-uitleg later op uw gsm om ze als app op uw gsm te plaatsen.';
